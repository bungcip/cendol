...
use crate::ir::{
    ...
    ExceptionTables, ExtFuncData, FuncRef, Immediate, InlineAsmData, InlineAsmId, Inst, JumpTables,
    MemFlagsSet, RelSourceLoc, SigRef, Signature, Type, Value, ValueLabelAssignments, ValueList,
    ValueListPool, types,
};
...
pub struct DataFlowGraph {
    ...
    pub inline_asms: PrimaryMap<InlineAsmId, InlineAsmData>,
}
