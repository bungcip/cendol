...
pub use crate::ir::entities::{
    ...
    GlobalValue, Immediate, InlineAsmId, Inst, JumpTable, SigRef, StackSlot, UserExternalNameRef,
    Value,
};
...
pub use crate::ir::inline_asm::{AsmConstraintKind, AsmOperand, InlineAsmData};
