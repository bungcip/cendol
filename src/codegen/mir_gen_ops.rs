...
mod tests {
    use super::*;
    use crate::ast::{BinaryOp, UnaryOp};
    use crate::mir::{BinaryFloatOp, BinaryIntOp, ConstValueId, Operand, Rvalue, UnaryFloatOp, UnaryIntOp};
    ...
    fn test_mir_ops_mapping() {
        ...
        let op1 = Operand::Constant(ConstValueId::new(1).unwrap());
        let op2 = Operand::Constant(ConstValueId::new(2).unwrap());
