...
impl PPKeywordTable {
    /// ⚡ Bolt: Optimized to use a global static instance.
    /// This ensures keywords are interned only once per process, reducing
    /// initialization overhead for every translation unit.
    pub(crate) fn new() -> Self {
        static INSTANCE: std::sync::OnceLock<PPKeywordTable> = std::sync::OnceLock::new();
        INSTANCE
            .get_or_init(|| PPKeywordTable {
