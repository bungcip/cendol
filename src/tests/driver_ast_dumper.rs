...
fn test_parsed_ast_sizeof_alignof() {
    ...
    5: Cast(PType { base: 1, declarator: 3, quals: TypeQuals(0x0) }, 4)
    6: SizeOfType(PType { base: 2, declarator: 4, quals: TypeQuals(0x0) })
    7: BinaryOp(Add, 5, 6)
    8: LiteralInt(1, None, base=10)
    9: SizeOfExpr(8)
    10: BinaryOp(Add, 7, 9)
    11: AlignOfType(PType { base: 3, declarator: 5, quals: TypeQuals(0x0) })
...
fn test_parsed_ast_compound_literal() {
    ...
    9: CompoundLiteral(PType { base: 1, declarator: 4, quals: TypeQuals(0x0) }, 8)
    10: MemberAccess(9, a, .)
    11: Return(10)
    "#);
}
...
fn test_parsed_ast_generic() {
    ...
    3: CompoundStmt(stmts=[8])
    4: LiteralInt(1, None, base=10)
    5: GenericSelection(4, [PGenericAssoc { type_name: Some(PType { base: 1, declarator: 3, quals: TypeQuals(0x0) }), result_expr: 6 }, PGenericAssoc { type_name: None, result_expr: 7 }])
    6: LiteralInt(1, None, base=10)
