...
fn test_member_access_missing_identifier() {
    ...
    run_fail_with_message(source, "Unexpected token: expected identifier, found IntegerConstant");
}
...
fn test_designated_initializer_missing_field() {
    ...
    run_fail_with_message(source, "Unexpected token: expected identifier, found Plus");
}
