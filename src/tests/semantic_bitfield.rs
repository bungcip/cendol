...
#[test]
fn test_struct_bitfield_features() {
    // --- test_struct_bitfield_parsing_and_layout ---
    let source = r#"
        #include <stdint.h>
    ...
    // --- test_bitfield_assignment_truncation ---
    let source = r#"
        struct S {
            int i : 2;
            unsigned j : 2;
    ...
    "#;
    assert_eq!(run_c_code_exit_status(source), 0);
    // --- test_anonymous_bitfield_alignment ---
    let source = r#"
        struct S {
            char a;
    ...
    "#;
    assert_eq!(run_c_code_exit_status(source), 0);
    // --- test_unnamed_bitfield_init_excess_elements ---
    ...
    // --- test_unnamed_bitfield_init_exact_elements ---
    // Unnamed bitfields should be skipped during initialization.
