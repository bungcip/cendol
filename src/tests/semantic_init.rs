...
#[test]
fn test_init_range_features() {
    // --- test_init_range_index_advancement ---
    let source = r#"
    int main() {
        int a[5] = { [0 ... 2] = 1, 2, 3 };
    ...
    "#;
    assert_eq!(run_c_code_exit_status(source), 0);
    // --- test_init_range_excess_elements ---
    let source = r#"
    int main() {
    ...
    "#;
    assert_eq!(run_c_code_exit_status(source), 0);
    // --- test_init_range_nested_aggregate_override ---
    let source = r#"
...
#[test]
fn test_array_designator_const_eval() {
    // --- test_nonconstant_array_designator_rejected ---
    let source = r#"
        void test() {
            int i = 0;
            int a[2] = {[i]=1};
    ...
    // --- test_constant_array_designator_accepted ---
    let source = r#"
        void test() {
            int a[2] = {[0]=1};
        }
